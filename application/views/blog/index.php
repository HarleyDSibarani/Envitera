                                    ...
                                    <div class="card-body post-body p-2">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7 desc">
                                                ...
                                                <p class="card-text d-block"><?=$article['isi'] ?></p>
                        ...
                        <div class="col">
                            <div class="card w-100">
                                ...
                                <ul class="list-group list-group-flush">
                                    <?php foreach ($cuplikan as $cpl) : ?>
                                        <li class="list-group-item">
                                            <h4 class="m-auto"><?=$cpl['judul'] ?></h4>
                                            <div class="info">
                                                <span class="badge badge-light"><?=$cpl['tanggal'] ?></span>    
                                                <a href="#" class="badge badge-primary"><?=$cpl['username'] ?></a>
                                                <a href="#" class="badge badge-success"><?=$cpl['kategori'] ?></a>
                                            </div>
                                            <p class="m-auto isi"><?=$cpl['isi'] ?></p>
                                            <span><a href="<?=$cpl['link'] ?>" class="lanjut">lanjut</a></span>
                                        </li>
                                     <?php endforeach; ?>
